<script lang="ts" module>
	...
	const ICONS: Record<string, IconSpec> = {
		...
		eightoff: { motif: 'cells', suit: 'clubs', badge: '8' },
		yukon: { motif: 'fan', suit: 'clubs' },
		fortythieves: { motif: 'double', suit: 'hearts' },
		scorpion: { motif: 'tail', suit: 'spades' },
		castle: { motif: 'double', suit: 'spades' },
		bakersdozen: { motif: 'stack', suit: 'diamonds', badge: '13' },
		simplesimon: { motif: 'columns', suit: 'hearts' },
